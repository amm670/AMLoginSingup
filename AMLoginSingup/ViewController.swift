...
class ViewController: UIViewController {
    ...
    @IBAction func loginButtonTouchUpInside(_ sender: AnyObject) {
        ...
        if mode == .signup {
            ...
            Auth.auth().signIn(withEmail: loginEmailInputView.textFieldView.text!, password: loginPasswordInputView.textFieldView.text!) {
                (user, error) in
                if error != nil {
                    print(error!)
                }
    ...
    @IBAction func signupButtonTouchUpInside(_ sender: AnyObject) {
        ...
        if mode == .login {
            ...
            Auth.auth().createUser(withEmail: signupEmailInputView.textFieldView.text!, password: signupPasswordInputView.textFieldView.text!) {
                (user, error) in
                if error != nil {
                    print(error!)
                }
